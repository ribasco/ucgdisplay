...
public class GlcdPinMapConfig {
    ...
    /**
     * Creates a new instance of the {@link GlcdPinMapConfig}.
     */
    ...
    /**
     * @return A map of all the pin configurations
     */
    public Map<GlcdPin, Byte> getPinMap() {
        return Collections.unmodifiableMap(pinMap);
    }
