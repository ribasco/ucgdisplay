...
public interface Glcd {
  ...
  interface LD7032 {
     ...
     * </p>
     */
    GlcdDisplay D_64x32_60X32ALT = new GlcdDisplay(
        GlcdController.LD7032,
        "D_64x32_60X32ALT",
        8,
        4,
        GlcdBufferLayout.HORIZONTAL,
        new GlcdSetupInfo("u8g2_Setup_ld7032_60x32_alt_f", COM_4WSPI),
        new GlcdSetupInfo("u8g2_Setup_ld7032_i2c_60x32_alt_f", COM_I2C)
    );
  ...
  interface LS027B7DH01 {
     ...
     * </p>
     */
    GlcdDisplay D_400x240_M0400X240 = new GlcdDisplay(
        GlcdController.LS027B7DH01,
        "D_400x240_M0400X240",
        50,
        30,
        GlcdBufferLayout.HORIZONTAL,
        new GlcdSetupInfo("u8g2_Setup_ls027b7dh01_m0_400x240_f", COM_4WSPI)
    );
  }
  ...
  interface MAX7219 {
     ...
     * </p>
     */
    GlcdDisplay D_16x16 = new GlcdDisplay(
        GlcdController.MAX7219,
        "D_16x16",
        2,
        2,
        GlcdBufferLayout.HORIZONTAL,
        new GlcdSetupInfo("u8g2_Setup_max7219_16x16_f", COM_4WSPI)
    );
  }
  ...
  interface S1D15E06 {
     ...
     * </p>
     */
    GlcdDisplay D_160x104_160100 = new GlcdDisplay(
        GlcdController.S1D15E06,
        "D_160x104_160100",
        20,
        13,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_s1d15e06_160100_f", COM_4WSPI | COM_6800 | COM_8080)
    );
  }
  ...
  interface SH1106 {
     ...
     * </p>
     */
    GlcdDisplay D_128x32_128X32VISIONOX = new GlcdDisplay(
        GlcdController.SH1106,
        "D_128x32_128X32VISIONOX",
        16,
        4,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_sh1106_128x32_visionox_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_sh1106_i2c_128x32_visionox_f", COM_I2C)
    );
  ...
  interface SSD1305 {
     ...
     * </p>
     */
    GlcdDisplay D_128x64_128X64RAYSTAR = new GlcdDisplay(
        GlcdController.SSD1305,
        "D_128x64_128X64RAYSTAR",
        16,
        8,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_ssd1305_128x64_raystar_f", COM_4WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_ssd1305_i2c_128x64_raystar_f", COM_I2C)
    );
  ...
  interface SSD1306 {
     ...
     * </p>
     */
    GlcdDisplay D_2040x16 = new GlcdDisplay(
        GlcdController.SSD1306,
        "D_2040x16",
        255,
        2,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_ssd1306_2040x16_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080)
    );
  ...
  interface ST7528 {
     ...
     * </p>
     */
    GlcdDisplay D_160x64_ERC16064 = new GlcdDisplay(
        GlcdController.ST7528,
        "D_160x64_ERC16064",
        20,
        8,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_st7528_erc16064_f", COM_4WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_st7528_i2c_erc16064_f", COM_I2C)
    );
  }
  ...
  interface ST7565 {
     ...
     * </p>
     */
    GlcdDisplay D_128x64_KS0713 = new GlcdDisplay(
        GlcdController.ST7565,
        "D_128x64_KS0713",
        16,
        8,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_st7565_ks0713_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080)
    );
  ...
  interface ST7567 {
     ...
     * </p>
     */
    GlcdDisplay D_64x32_HEM6432 = new GlcdDisplay(
        GlcdController.ST7567,
        "D_64x32_HEM6432",
        8,
        4,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_st7567_hem6432_f", COM_4WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_st7567_i2c_hem6432_f", COM_I2C)
    );
  ...
  interface ST7571 {
     ...
     */
    GlcdDisplay D_128x128 = new GlcdDisplay(
        GlcdController.ST7571,
        "D_128x128",
        16,
        16,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_st7571_128x128_f", COM_4WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_st7571_i2c_128x128_f", COM_I2C)
    );
  }
  ...
  interface ST7586S {
     ...
     * </p>
     */
    GlcdDisplay D_240x160_YMC240160 = new GlcdDisplay(
        GlcdController.ST7586S,
        "D_240x160_YMC240160",
        30,
        20,
        GlcdBufferLayout.HORIZONTAL,
        new GlcdSetupInfo("u8g2_Setup_st7586s_ymc240160_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080)
    );
  ...
  interface UC1608 {
     ...
     * </p>
     */
    GlcdDisplay D_240x64_DEM240064 = new GlcdDisplay(
        GlcdController.UC1608,
        "D_240x64_DEM240064",
        30,
        8,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_uc1608_dem240064_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_uc1608_i2c_dem240064_f", COM_I2C)
    );
  ...
  interface UC1611 {
     ...
     * </p>
     */
    GlcdDisplay D_256x128_IDS4073 = new GlcdDisplay(
        GlcdController.UC1611,
        "D_256x128_IDS4073",
        32,
        16,
        GlcdBufferLayout.VERTICAL,
        new GlcdSetupInfo("u8g2_Setup_uc1611_ids4073_f", COM_4WSPI | COM_3WSPI | COM_6800 | COM_8080),
        new GlcdSetupInfo("u8g2_Setup_uc1611_i2c_ids4073_f", COM_I2C)
    );
