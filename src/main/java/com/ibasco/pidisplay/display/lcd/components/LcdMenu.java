...
import com.ibasco.pidisplay.display.lcd.LcdDisplay;
import com.ibasco.pidisplay.display.lcd.LcdGraphics;
import com.ibasco.pidisplay.display.lcd.enums.LcdMenuCursorOrientation;
import com.ibasco.pidisplay.display.lcd.enums.LcdMenuItemStyle;
import com.ibasco.pidisplay.display.lcd.events.LcdMenuItemEvent;
import com.ibasco.pidisplay.display.lcd.events.LcdMenuNavEvent;
...
public class LcdMenu extends LcdDisplay {

    private static final Logger log = LoggerFactory.getLogger(LcdMenu.class);
    ...
    public LcdMenu(Node<String> root) {
