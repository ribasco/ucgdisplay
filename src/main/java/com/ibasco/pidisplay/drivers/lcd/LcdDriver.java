package com.ibasco.pidisplay.drivers.lcd;

import com.ibasco.pidisplay.core.exceptions.NotImplementedException;
import com.ibasco.pidisplay.drivers.lcd.adapters.StdGpioLcdAdapter;
import com.ibasco.pidisplay.drivers.lcd.enums.*;
import com.ibasco.pidisplay.drivers.lcd.exceptions.LcdNotInitializedException;
...
public class LcdDriver extends LCDBase implements LCD {
    ...
    private volatile byte displayFunction;
     ...
     */
    public LcdDriver(LcdPinMapConfig lcdPinMap, int cols, int rows) throws IOException {
     ...
     */
    public LcdDriver(LcdGpioAdapter lcdGpioAdapter, int cols, int rows) throws IOException {
     ...
     */
    public LcdDriver(LcdGpioAdapter lcdGpioAdapter, int cols, int rows, LcdOperationMode operationMode) throws IOException {
     ...
     */
    public LcdDriver(LcdGpioAdapter lcdGpioAdapter, int cols, int rows, LcdOperationMode operationMode, LcdCharSize charSize) throws IOException {
     ...
     */
    public void scrollDisplay(LcdScrollDirection direction) {
        command(LCD_CURSORSHIFT | LCD_DISPLAYMOVE | direction.getValue());
    }
     ...
     */
    public void textDirection(LcdTextDirection textDirection) {
        setInstruction(LcdInstruction.DISPLAY_MODE, LCD_ENTRYLEFT, textDirection == LcdTextDirection.LEFT_TO_RIGHT);
        command(LCD_ENTRYMODESET | this.displayMode);
    }
