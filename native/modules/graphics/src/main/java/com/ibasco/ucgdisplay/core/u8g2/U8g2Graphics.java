...
public class U8g2Graphics {
     ...
     */
    public static native long setup(String setupProc, int busInterface, int busInterfaceType, int rotation, int address, String transportDevice, String gpioDevice, byte[] pinConfig, boolean virtual);
     ...
     *
     * @param id
     *         The display instance id retrieved via {@link #setup(String, int, int, int, int, String, String, byte[], boolean)}
     * @param x
