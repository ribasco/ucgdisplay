 ...
 * =========================END==================================
 */
#ifndef UCGD_MOD_GRAPHICS_UCGDCPERGPIOPERIPHERAL_H
#define UCGD_MOD_GRAPHICS_UCGDCPERGPIOPERIPHERAL_H
...
class UcgdCperGpioPeripheral : public UcgdGpioPeripheral {
public:
    explicit UcgdCperGpioPeripheral(const std::shared_ptr<UcgdProvider>& provider);

    ~UcgdCperGpioPeripheral() override;
...
#endif //UCGD_MOD_GRAPHICS_UCGDCPERGPIOPERIPHERAL_H
