 ...
 * =========================END==================================
 */
#ifndef UCGD_MOD_GRAPHICS_UCGDI2CPERIPHERAL_H
#define UCGD_MOD_GRAPHICS_UCGDI2CPERIPHERAL_H
...
class UcgdI2CPeripheral : public UcgdPeripheral {

public:
    explicit UcgdI2CPeripheral(const std::shared_ptr<UcgdProvider>& provider) : UcgdPeripheral(provider) {}

    ~UcgdI2CPeripheral() override {
        debug("UcgdI2CPeripheral: destructor");
    }
