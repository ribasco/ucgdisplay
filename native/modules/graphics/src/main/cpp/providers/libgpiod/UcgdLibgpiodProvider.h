 ...
 * Filename: UcgLibgpiodProvider.h
 * 
 * ---------------------------------------------------------
 * %%
 ...
 * =========================END==================================
 */
#ifndef UCGD_MOD_GRAPHICS_UCGDLIBGPIODPROVIDER_H
#define UCGD_MOD_GRAPHICS_UCGDLIBGPIODPROVIDER_H

#include <UcgdProvider.h>
#include <gpiod.hpp>

class UcgdLibgpiodProvider : public UcgdProvider, public std::enable_shared_from_this<UcgdLibgpiodProvider> {
public:
    explicit UcgdLibgpiodProvider();

    ~UcgdLibgpiodProvider() override;
    ...
    std::shared_ptr<UcgdLibgpiodProvider> getPointer();
...
#endif //UCGD_MOD_GRAPHICS_UCGDLIBGPIODPROVIDER_H
