...
void UcgPigpioGpioProvider::init(const std::shared_ptr<ucgd_t> &context, int pin, UcgGpioProvider::GpioMode mode) {
    ...
    int res = gpioSetMode(pin, UcgPigpioCommon::gpioModeToPigpio(mode));
