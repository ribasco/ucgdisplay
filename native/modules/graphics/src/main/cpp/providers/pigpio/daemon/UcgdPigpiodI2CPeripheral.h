...
class UcgdPigpiodI2CPeripheral : public UcgdI2CPeripheral {
public:
    explicit UcgdPigpiodI2CPeripheral(const std::shared_ptr<UcgdProvider>& provider);

    ~UcgdPigpiodI2CPeripheral() override;
