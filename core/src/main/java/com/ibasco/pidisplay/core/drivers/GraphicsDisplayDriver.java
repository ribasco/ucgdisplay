...
public interface GraphicsDisplayDriver extends DisplayDriver {
     ...
     *
     * @see #getBuffer()
     * @deprecated As of 2.23 this has been renamed to getBufferCurrTileRow
     */
    @Deprecated
    int getPageCurrTileRow();
     ...
     * @see #getBuffer
     * @see #sendBuffer
     * @deprecated As of 2.23, this is now renamed to setBufferCurrTileRow
     */
    @Deprecated
    void setPageCurrTileRow(int row);
